...
model_checkpoint = ModelCheckpoint(
    filepath=os.path.join(models_dir, 'classification_VGG16_BM_5.keras'),
    save_best_only=True,
    monitor='val_loss',
    mode='min'
)
...
model.save(os.path.join(models_dir, 'classification_VGG16_5.keras'))

with open(os.path.join(models_dir, 'classification_VGG16_5_history.pkl'), 'wb') as file:
