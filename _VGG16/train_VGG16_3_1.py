...
model_checkpoint = ModelCheckpoint(
    filepath=os.path.join(models_dir, 'classification_VGG16_BM_3_1.keras'),
    save_best_only=True,
    monitor='val_loss',
    mode='min'
)
...
model.save(os.path.join(models_dir, 'classification_VGG16_3_1.keras'))

with open(os.path.join(models_dir, 'classification_VGG16_3_1_history.pkl'), 'wb') as file:
