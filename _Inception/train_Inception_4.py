...
model_checkpoint = ModelCheckpoint(
    filepath=os.path.join(models_dir, 'classification_InceptionV3_4_BM.keras'),
    save_best_only=True,
    monitor='val_loss',
    mode='min'
)
...
# 모델 저장
model.save(os.path.join(models_dir, 'classification_InceptionV3_4.keras'))

# 훈련 이력 저장
with open(os.path.join(models_dir, 'classification_InceptionV3_4_history.pkl'), 'wb') as file:
